...
const VolunteerNeedPosts = () => {
    ...
    const fetchPosts = async () => {
        const {data} = await axios.get(`${import.meta.env.VITE_API_URL}/posts/${user?.email}`);
        setPosts(data);
    }
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex items-center gap-x-2">
                            <p
                              ...
                              ${job?.category === "Social service" && "text-purple-500"}
                              ${job?.category === "Animal welfare" && "text-red-500"}
