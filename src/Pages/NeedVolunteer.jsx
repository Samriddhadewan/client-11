...
const NeedVolunteer = () => {
  ...
  const handleSubmit = (e)=>{
    ...
    const min_volunteer = form.min_volunteer.value;
    ...
    const postData = {
      title, thumbnail, description,category, location, min_volunteer, deadline, organizer, request_count
    }
          ...
          <form onSubmit={handleSubmit} className="">
            ...
            <fieldset className="fieldset">
              ...
              <div className="flex flex-col gap-2 ">
                ...
                <DatePicker className=" p-2 rounded-md w-full border" 
                selected={startDate} 
